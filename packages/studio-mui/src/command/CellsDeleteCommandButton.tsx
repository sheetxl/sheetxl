...
export interface CellsDeleteCommandButtonProps extends CommandPopupButtonProps {
...
export const CellsDeleteCommandButton = memo(
  forwardRef<HTMLElement, CellsDeleteCommandButtonProps>((props, refForwarded) => {
  const {

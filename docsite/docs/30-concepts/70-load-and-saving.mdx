...
APIS details are available in the [API docs](https://api.sheetxl.com/classes/_sheetxl_io.DefaultWorkbookIO.html#read).
...
:::tip
The full source documentation is available at [API IWorkbookIO](https://api.sheetxl.com/types/_sheetxl_io.IOSource.html)
:::

### Using Studio

If using the Studio React component this capabilities in wrapped in the workbook properties.
